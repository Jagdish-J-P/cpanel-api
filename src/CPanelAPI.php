 ...
 *
 * For all the available operations:
...
class CPanelAPI
{
    ...
    {
        return ($this->authType == AuthType::TOKEN ? $this->user . ":" . $this->pass : base64_encode($this->user . ":" . $this->pass));
    }
    ...
    {
        $httpHeaders = array("Authorization: {$this->authType->value} " . $this->auth);
